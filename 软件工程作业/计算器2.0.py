...
button_division2 = tk.Button(root, text='//', width=5, font=("宋体", 16), relief='flat', background='#C0C0C0',command=lambda :operator('//'))
...
button_multiplication2 = tk.Button(root, text='xx', width=5, font=("宋体", 16), relief='flat', background='#C0C0C0',command=lambda :operator('**'))
button_multiplication2.grid(padx=4, row=4, column=3)

button_zero = tk.Button(root, text='0', width=5, font=("宋体", 16), relief='flat', background='#b3d4fc',command=lambda :append_num('0'))
...
button_equal = tk.Button(root, text='=', width=5, font=("宋体", 16), relief='flat', background='#00CED1',command=lambda :equal())
